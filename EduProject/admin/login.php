                ...
                if ($query->num_rows == 1) {
                    ...
                    if ($query->fetch()) {
                        if (password_verify($password, $hashedPassword)) {
                            ...
                            $passwordError = "That password is not valid!";
                        }
                    } else { // The SQL query couldn't be executed for some reason...
                        echo "ERROR CODE BEETLE (ADMIN): Could not fetch your details. Please try again!";
                    }
                } else { // The username doesn't exist.
                    $usernameError = "That username doesn't exist!";
                }
            } else { // The SQL query couldn't be executed for some reason...
